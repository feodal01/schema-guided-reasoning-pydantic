...
| Topic | File |
|--------|------|
| SGR pattern playbook (Cascade / Routing / Cycle) | [patterns.md](./patterns.md) |
| Copy-paste Pydantic templates | [templates.md](./templates.md) |
| Caveats that apply to **every** provider | [cross-cutting-caveats.md](./cross-cutting-caveats.md) |
